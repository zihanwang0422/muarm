...
class JointPublisher(Node):
    def __init__(self):
        ...
        self.get_logger().info('Joint Publisher node started, publishing at 50Hz')
    ...
    def timer_callback(self):
        ...
        self.get_logger().info(f'Published joint angles: {[f"{angle:.3f}" for angle in joint_angles]}')
