...
SID = os.environ.get("SID", "1155249290")
...
# Architecture optimized for <20k params with better capacity
...
callbacks = [
    ...
    keras.callbacks.EarlyStopping(
        monitor="val_loss",
        patience=50,  # TODO: Define patience
...
history = model.fit(
    ...
    epochs=500,  # TODO Define number of epochs
    validation_data=(
        X_test_scaled,
        y_test_scaled,
    ),
